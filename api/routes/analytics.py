...
@router.get("/summary", response_model=Dict[str, Any], summary="Get Department Analytics", description="Retrieves aggregated risk statistics across all departments from the database.")
